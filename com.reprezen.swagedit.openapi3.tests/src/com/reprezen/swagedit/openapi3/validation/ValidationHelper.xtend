...
class ValidationHelper {
	...
	def public void validate(JsonNode documentAsJson) {
		...
		val ErrorProcessor processor = new ErrorProcessor(null) {
		...
		new OpenApi3Validator(new OpenApi3ReferenceValidator(), preloadedSchemas).validateAgainstSchema(processor,
			schemaAsJson, documentAsJson)
	}
