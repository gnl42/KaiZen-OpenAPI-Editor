...
class SwaggerContentAssistProcessorTest {
	...
	val processor = new SwaggerContentAssistProcessor(null) {
		...
		override protected getContextTypeId(JsonDocument doc, String path) {
	...
	def void test3() {
		...
		assertThat(values,
			hasItems("$ref:", "format:", "title:", "description:", "multipleOf:", "maximum:", "exclusiveMaximum:",
				"minimum:", "exclusiveMinimum:", "maxLength:", "minLength:", "pattern:", "maxItems:", "minItems:",
				"uniqueItems:", "maxProperties:", "minProperties:", "required:", "enum:", "additionalProperties:",
				"type:", "items:", "allOf:", "properties:", "discriminator:", "readOnly:", "xml:", "externalDocs:",
				"example:", "x-:"))
		...
		assertThat(values,
			hasItems("$ref:", "format:", "title:", "description:", "multipleOf:", "maximum:", "exclusiveMaximum:",
				"minimum:", "exclusiveMinimum:", "maxLength:", "minLength:", "pattern:", "maxItems:", "minItems:",
				"uniqueItems:", "maxProperties:", "minProperties:", "enum:", "additionalProperties:", "type:", "items:",
				"allOf:", "discriminator:", "readOnly:", "xml:", "externalDocs:", "example:", "x-:"))

		proposals = test.apply(processor, "3")
		values = proposals.map[(it as StyledCompletionProposal).replacementString]
		assertEquals(7, values.size)
		assertThat(values, hasItems("array", "boolean", "integer", "\"null\"", "number", "object", "string"))
	}
}
